...
namespace Game.Utilities
{
    public static class RectTransformExtension
    {
        ...
        public static void FitHorizontalByTexture(this RectTransform parent, RectTransform childRectTransform,
            Texture texture)
        {
        ...
        public static void FitVerticalByTexture(this RectTransform parent, RectTransform childRectTransform,
            Texture texture)
        {
            var ratio = (float) texture.width / texture.height;
